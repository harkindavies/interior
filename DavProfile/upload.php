    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="col-md-8 col-xs-8">
          ...
          <div class="form-group">
            <label class="label label-cyan" for="projectTitle">Title:</label>
            <input type="text" required class="form-control" name="projectTitle" id="projectTitle" value="" />
          </div>
          <div class="form-group">
